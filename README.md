...
Версия приложения: **0.10.0**. Аудит и перенос: **14 сентября 2026**.
...
Windows-перенос подготовлен кодом, но живой цикл на MSI не принят. Найдены пробелы
в целостности AI-пакетов и идентификации машин без VIN: см. аудит. Поисковый,
сверочный и карточечный контуры теперь связаны `cycle_id` и неизменяемым roster
manifest, но это ещё не заменяет живую приёмку.
