...
Рабочая редакция: 14.09.2026. Для текущего состояния сначала читайте production
roadmap, M7 acceptance и stage-gate records ниже. Верхнеуровневые исторические
технические документы сохранены как справочные; при расхождении текущие M7/stage
records имеют приоритет над старым аудитом и обещаниями.
...
- [AUDIT](analysis/AUDIT_2026-09-14.md) — исторический baseline-аудит 0.9.0;
  часть перечисленных P0 закрыта поздними milestones.
