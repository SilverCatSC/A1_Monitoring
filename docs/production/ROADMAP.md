...
1. Объединить итог поиска и прямых карточек в единую честную сводку.
2. Ввести `cycle_id`, immutable roster и manifest доказательств.
3. Заблокировать публикацию пустого, частичного или смешанного результата.
4. Добавить тесты на CAPTCHA, прямую карточку, timeout, пустой импорт и resume.
