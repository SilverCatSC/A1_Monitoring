...
1. Добавить fixtures и gates для timeout, пустого импорта и контролируемого resume.
2. Сделать явную операторскую очередь для incomplete evidence вместо смешивания с
