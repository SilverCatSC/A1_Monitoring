...
Дата: 14.09.2026. Версия staged-сборки: 0.14.0. Windows/MSI — целевой
production-контур, но ещё не прошёл живую приёмку этой сборки.
...
handoff, а не доказательством production-готовности.
...
### Host-runner и Windows Task Scheduler — только после Gate 4
